...
import { DonorStatus, UserPermission } from "@/database/tables";
...
export default function EditStatusTab(props: EditStatusTabProps) {
  ...
  const initialize = async () => {
    try {
      ...
      setLoading(true);
      // 2. Send data
      const response = await axiosClient.get(`donors/statuses/${id}`);
  ...
  const donor_status = permissions.sub.get(
    PermissionEnum.donor.sub.donor_status
  );
                          ...
                          <BooleanStatusButton
                            ...
                            getColor={function (): {
                              ...
                              return StatusEnum.registered ===
                                ...
                                : StatusEnum.blocked == donorStatus.status_id
                                ? {
